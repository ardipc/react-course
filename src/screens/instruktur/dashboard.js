    ...
    <Fragment>
      <div className="row">
        ...
        <div className="col-lg-4 col-md-12 col-12">
          ...
          <div className="card mb-4">
            <div className="p-4">
              <span className="font-size-xs text-uppercase font-weight-semi-bold">students Enrollments</span>
              <h2 className="mt-4 font-weight-bold mb-1 d-flex align-items-center h1 lh-1">
                12,000
              </h2>
              <span className="d-flex justify-content-between align-items-center">
        ...
        <div className="col-lg-4 col-md-12 col-12">
          ...
          <div className="card mb-4">
            <div className="p-4">
              <span className="font-size-xs text-uppercase font-weight-semi-bold">Courses Rating</span>
              <h2 className="mt-4 font-weight-bold mb-1 d-flex align-items-center h1 lh-1">
                4.80
              </h2>
              <span className="d-flex justify-content-between align-items-center">
